import { Departments } from './sharedrules';
...
export class Rules {
      ...
      backupCh:number[] = [];
      deadCh:number[] = [];
      abnoList:number[] = [2,1];//le Abno avranno una lista di base ma poi devono avere la exp memorizzata a parte quindi tanto vale avere una scheda nuova
      depsList:Departments[] = [Departments.Disciplinary, Departments.Safety, Departments.Information, Departments.Training, Departments.Custom1, Departments.Control]; //ENUM
